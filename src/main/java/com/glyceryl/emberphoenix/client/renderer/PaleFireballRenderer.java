...
public class PaleFireballRenderer extends EntityRenderer<PaleFireball> {

    private static final ResourceLocation TEXTURE_LOCATION = EmberOfPhoenix.prefix("textures/entity/pale_fireball.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public PaleFireballRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    protected int getBlockLightLevel(PaleFireball paleFireball, BlockPos blockPos) {
        return 15;
    }

    public void render(PaleFireball paleFireball, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource source, int packedLight) {
        poseStack.pushPose();
        ...
        poseStack.popPose();
        super.render(paleFireball, entityYaw, partialTicks, poseStack, source, packedLight);
    }
    ...
    public ResourceLocation getTextureLocation(PaleFireball paleFireball) {

...
public class PaleFireballRenderer extends EntityRenderer<PaleFireball> {
    ...
    public void render(PaleFireball paleFireball, float p_114081_, float p_114082_, PoseStack poseStack, MultiBufferSource source, int p_114085_) {
        poseStack.pushPose();
        ...
        poseStack.popPose();
        super.render(paleFireball, p_114081_, p_114082_, poseStack, source, p_114085_);
    }

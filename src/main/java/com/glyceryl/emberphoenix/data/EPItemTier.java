...
public class EPItemTier {
    ...
    public static final Tier BLAZE = TierSortingRegistry.registerTier(
            new ForgeTier(4, 500, 12.0F, 10.0F, 15, BlockTags.create(EmberOfPhoenix.prefix("needs_blaze_tool")),
    ...
    public static final Tier EMBER = TierSortingRegistry.registerTier(
            new ForgeTier(4, 300, 8.0F, 5.0F, 10, BlockTags.create(EmberOfPhoenix.prefix("needs_ember_tool")),

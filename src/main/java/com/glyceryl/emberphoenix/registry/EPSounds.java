...
public class EPSounds {
    ...
    private static final RegistryObject<SoundEvent> EQUIP_BLAZE = registerSoundEvents("equip_blaze");
    private static final RegistryObject<SoundEvent> EQUIP_EMBERIUM = registerSoundEvents("equip_emberium");

...
public class EPItems {
    ...
    public static final RegistryObject<Item> EMBER_SWORD = RegistryBase.ITEMS.register("ember_sword", () -> new SwordItem(EPItemTier.EMBER, 3,-2.4F, fireProof()));
    public static final RegistryObject<Item> EMBER_SHOVEL = RegistryBase.ITEMS.register("ember_shovel", () -> new EPShovel(EPItemTier.EMBER, 1.5F,-3.0F, fireProof()));
    public static final RegistryObject<Item> EMBER_PICKAXE = RegistryBase.ITEMS.register("ember_pickaxe", () -> new PickaxeItem(EPItemTier.EMBER, 1,-2.8F, fireProof()));
    public static final RegistryObject<Item> EMBER_AXE = RegistryBase.ITEMS.register("ember_axe", () -> new AxeItem(EPItemTier.EMBER, 5.0F,-3.0F, fireProof()));
    public static final RegistryObject<Item> EMBER_HOE = RegistryBase.ITEMS.register("ember_hoe", () -> new HoeItem(EPItemTier.EMBER, -4,0.0F, fireProof()));
    //注册新的盔甲
    public static final RegistryObject<Item> EMBER_HELMET = RegistryBase.ITEMS.register("ember_helmet", () -> new ArmorItem(EPArmorMaterials.EMBERIUM, EquipmentSlot.HEAD, fireProof()));
    public static final RegistryObject<Item> EMBER_CHESTPLATE = RegistryBase.ITEMS.register("ember_chestplate", () -> new ArmorItem(EPArmorMaterials.EMBERIUM, EquipmentSlot.CHEST, fireProof()));
    public static final RegistryObject<Item> EMBER_LEGGINGS = RegistryBase.ITEMS.register("ember_leggings", () -> new ArmorItem(EPArmorMaterials.EMBERIUM, EquipmentSlot.LEGS, fireProof()));
    public static final RegistryObject<Item> EMBER_BOOTS = RegistryBase.ITEMS.register("ember_boots", () -> new ArmorItem(EPArmorMaterials.EMBERIUM, EquipmentSlot.FEET, fireProof()));
    //注册带有特殊功能的物品

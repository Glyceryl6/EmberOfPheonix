...
public class EPItems {
    ...
    public static final RegistryObject<Item> BLAZE_HELMET = RegistryBase.ITEMS.register("blaze_helmet", () -> new ArmorItem(EPArmorMaterials.BLAZE, EquipmentSlot.HEAD, fireProof()));
    public static final RegistryObject<Item> BLAZE_CHESTPLATE = RegistryBase.ITEMS.register("blaze_chestplate", () -> new ArmorItem(EPArmorMaterials.BLAZE, EquipmentSlot.CHEST, fireProof()));

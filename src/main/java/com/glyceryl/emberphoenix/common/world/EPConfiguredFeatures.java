...
public class EPConfiguredFeatures {
    ...
    public static final Holder<ConfiguredFeature<BiggerLavaLakeFeature.Configuration, ?>> BIGGER_LAKE_LAVA = register("bigger_lake_lava", EPFeatures.BIGGER_LAKE,
            new BiggerLavaLakeFeature.Configuration(BlockStateProvider.simple(Blocks.LAVA.defaultBlockState()), BlockStateProvider.simple(EPBlocks.SCARLET_STONE.get())));

    public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> TRIPLE_ASH_LAYER = register("triple_ash_layer", EPFeatures.TRIPLE_ASH_LAYER, FeatureConfiguration.NONE);

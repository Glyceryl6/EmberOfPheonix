...
public class BiggerLavaLakeFeature extends Feature<BiggerLavaLakeFeature.Configuration> {

    private static final BlockState AIR = Blocks.CAVE_AIR.defaultBlockState();

    public BiggerLavaLakeFeature(Codec<BiggerLavaLakeFeature.Configuration> codec) {
        super(codec);
    }

    public boolean place(FeaturePlaceContext<BiggerLavaLakeFeature.Configuration> context) {
    ...
    public record Configuration(BlockStateProvider fluid, BlockStateProvider barrier) implements FeatureConfiguration {
        public static final Codec<BiggerLavaLakeFeature.Configuration> CODEC = RecordCodecBuilder.create((p_190962_) ->
                p_190962_.group(BlockStateProvider.CODEC.fieldOf("fluid").forGetter(BiggerLavaLakeFeature.Configuration::fluid),
                        BlockStateProvider.CODEC.fieldOf("barrier").forGetter(BiggerLavaLakeFeature.Configuration::barrier)).apply(p_190962_, BiggerLavaLakeFeature.Configuration::new));
    }
}

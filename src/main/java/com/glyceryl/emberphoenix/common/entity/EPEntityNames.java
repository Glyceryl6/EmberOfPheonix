package com.glyceryl.emberphoenix.common.entity;

import net.minecraft.resources.ResourceLocation;

import static com.glyceryl.emberphoenix.EmberOfPhoenix.prefix;

@SuppressWarnings("unused")
public class EPEntityNames {

    public static final ResourceLocation WEEPER = prefix("weeper");
    public static final ResourceLocation WILDFIRE = prefix("wildfire");
    public static final ResourceLocation UNFORTUNATE = prefix("unfortunate");
